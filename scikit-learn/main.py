...
# %% split test and train data and verify labelled data is split evenly
...
class LogisticRegressionGD:
    ...
    def __init__(self, eta=0.01, n_iter=50, random_state=1):
        self.eta = eta
        self.n_iter = n_iter
        self_random_state = random_state
    ...
    def fit(self, X, y):
        ...
        """
        rgen = np.random.RadnomState(self.random_state)
